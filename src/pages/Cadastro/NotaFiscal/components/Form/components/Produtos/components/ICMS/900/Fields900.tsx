    ...
    <Flex w="100%" align="center" justify="flex-start" direction="column">
      ...
      <Flex w="100%" align="center" justify="flex-start">
        ...
        <FormContainer label='Percentual de redução de base ICMS'>
          <PorcentAddon>
            <Input maxLength={255} defaultValue={0} borderColor={colorMode === 'light' ? 'blackAlpha.600' : 'gray.600'} type="number" {...register('p_reducao_base_icms')} />
          </PorcentAddon>
        </FormContainer>
      </Flex>
      <Flex w="100%" align="center" justify="flex-start">
        <FormContainer label='Alíquota ICMS' mr='3'>
          <PorcentAddon>
            <Input maxLength={255} defaultValue={0} borderColor={colorMode === 'light' ? 'blackAlpha.600' : 'gray.600'} type="number" {...register('produto.aliquota_icms')} />
          </PorcentAddon>
        </FormContainer>
      ...
      <Flex w="100%" align="center" justify="flex-start">
        <FormContainer label='Base de Cálculo' mr='3'>
          <MoneyAddon>
            <Input maxLength={255} defaultValue={0} borderColor={colorMode === 'light' ? 'blackAlpha.600' : 'gray.600'} type="number" {...register('produto.base_icms')} />
          </MoneyAddon>
        </FormContainer>
      ...
      <Flex w="100%" align="center" justify="flex-start">
        <FormContainer label='Valor ICMS' mr='3'>
          <MoneyAddon>
            <Input maxLength={255} defaultValue={0} borderColor={colorMode === 'light' ? 'blackAlpha.600' : 'gray.600'} type="number" readOnly {...register('valor_icms')} />
          </MoneyAddon>
        </FormContainer>
